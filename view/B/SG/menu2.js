...
<script>\
    document.addEventListener("DOMContentLoaded", function(){\
        ...
        var favouriteLink = document.getElementById("favouriteLink");\
        if(memberEmail == null || memberEmail == "") {\
            ...
            favouriteLink.setAttribute("style", "pointer-events:none; color:grey");\
        }\
        else {\
            ...
            favouriteLink.setAttribute("href", "/B/' + countryPrefix + '/favourite.html?cat=" + encodeURIComponent("Favourite"));\
            favouriteLink.setAttribute("style", "");\
        }\
        ...
        document.getElementById("servicesLink").setAttribute("href", "/B/' + countryPrefix + '/services.html");\
    }, false);\
    function logout() {\
        ...
        <div id="menuLoggedIn" style="display: none;">\
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li><a id="memberName" class="welcome-text"></a></li>\
                </ul>\
                <button class="btn btn-responsive-nav btn-inverse" data-toggle="collapse" data-target=".nav-main-collapse">\
                    <i class="icon icon-bars"></i>\
                </button>\
        ...
        <div class="container">\
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    ...
                    <li>\
                        <a id="favouriteLink" style="pointer-events:none; color:grey"><i class="icon icon-heart"></i> Favourites</a>\
                    </li>\
                    <li>\
                        <a id="servicesLink"><i class="icon icon-map-marker"></i> Services</a>\
                    </li>\
                </ul>\
            </nav>\
        </div>\
